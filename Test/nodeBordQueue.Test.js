...
test("Test ProcuraNoPorId", function() {
    var objNo = new nodeBordQueue( '123', '123');
    var objNo2 = new nodeBordQueue( '444', '123');
    objNo.addArco(objNo2)
